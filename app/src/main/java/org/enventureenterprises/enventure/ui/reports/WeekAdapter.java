...
public class WeekAdapter extends PagerAdapter {
    ...
    private Realm realm;
    private RealmResults<WeeklyReport> reports;




    @Inject
    public WeekAdapter(Context context,RealmResults<WeeklyReport> reports) {
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        final WeeklyReport report = reports.get(position);
