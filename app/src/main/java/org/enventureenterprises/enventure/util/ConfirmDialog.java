...
/**
 * Created by mossplix on 4/30/17.
 */
...
public class ConfirmDialog extends AppCompatDialog {
    ...
    protected @BindView(R.id.title_text_view)
    TextView titleTextView;
    protected @BindView(R.id.message_text_view) TextView messageTextView;
    protected @BindView(R.id.ok_button)
    Button okButton;
    ...
    public void setTitleText(final @NonNull String title) {
        ...
        params.topMargin = (int) getContext().getResources().getDimension(R.dimen.margin_small);
